...
function sum(shoes:number,suit:number){
...
function sumMarks(eng:number,urdu:number,math:number,physics:number,sst:number){
...
let result: number = sum1(1, 2, 3, 4, 5);
